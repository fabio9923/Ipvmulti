...
public:
	...
	/** The player's current ammo count */
	...
	/** RepNotify for changes made to current ammo */
	UFUNCTION()
	void OnRep_CurrentAmmo();

	/** Function to check if player can fire (has ammo) */
	UFUNCTION(BlueprintPure, Category = "Ammo")
	bool CanFire() const;

	/** Function to decrease ammo (server only) */
	UFUNCTION(Server, Reliable)
	void DecreaseAmmo();

	/** Function to reload ammo (server only) */
	UFUNCTION(Server, Reliable)
	void ReloadAmmo();
